...
![FileTree pane with a source preview and searchable file tree](docs/screenshots/files.png)
...
Opens supported files automatically. Or choose **+ → FileTree** in the right panel. File access is read-only.
